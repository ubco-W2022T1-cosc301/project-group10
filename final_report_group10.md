...
Our findings helped confirm the validity of some of the beliefs held around the hockey world. The home team advantage was strongly confirmed during the season, though there was a strange outlier where two-goal games were more often won by visiting teams rather than home teams. The distance between two opponents' home arenas did have an effect, albeit a slight one, on the performance of *both* teams. Oddly, the further the visiitng team had traveled, the more likely they were to win. With an 82 game season plus the addition of playoff games, the NHL season is a grind and rest days are paramount. Over the season, having 0 days of rest decreased the win rate of a team significantly (-10%). The outliers to this stat are Vancouver with a -25% difference in win rate, Colorado with an 8% increase in win rate, and Tampa Bay with a 20% increase in win rate. Underdogs were determined as teams that had a difference in rating of over 100 and were expected to lose the game. We found that the best underdogs (those who won despite the odds), were Vancouver, followed by Buffalo and Ottawa. Coincidentally, all three of these teams missed the playoffs. Regarding making predictions on how a season will turn out, we found that the 20 game mark is a very good predictor of end of season standings. Two-thirds (2/3) of teams are likely to finish within 5 positions (+/-) of where they were after the 20th game. FiveThirtyEight uses 3 derived stats that are correlated with each other: "Quality", "Importance", "Overall" to predict games. We found that the "Quality" stat can accurately predict good teams but is unable to predict whether a specific game will be perceived as "good" by a human. Lastly we found home teams with a higher game attendance win more, but it is difficult to determine how much of that impact is due to the fans. Better teams will attract more people to come watch and that may account partially for this finding. Ultimately, though, this dataset covered only one season -- it would be interesting to explore how these findings hold over a longer period of five or ten seasons.
